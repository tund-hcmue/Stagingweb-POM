...
//             File theDir = new File(System.getProperty("user.dir") + fileSeperator);
//             if (!theDir.exists()){
//                 theDir.mkdirs();
//             }
//             // Chổ này đặt tên thì truyền biến "screenName" gán cho tên File chụp màn hình
//             FileHandler.copy(source, new File(System.getProperty("user.dir") + "src/test/java/com/example/core/report/screenCapture" + "/" + screenName + "_" + dateFormat.format(new Date()) + ".png"));
